...
export const ChatSidebar = () => (
  <aside className="w-full md:w-80 bg-white border-r flex flex-col md:h-auto max-h-[40vh] md:max-h-none min-h-0">
    <div className="p-4 border-b">
      ...
      <div className="relative">
        ...
        <input 
          ...
          className="w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-100 rounded-lg text-xs outline-none focus:ring-1 focus:ring-yellow-500"
        />
      </div>
    </div>
    ...
    <div className="flex-1 overflow-y-auto">
      {[1, 2, 3, 4].map((_, i) => (
        <div key={i} className={`p-4 flex gap-3 cursor-pointer border-b border-gray-50 hover:bg-gray-50 transition-colors ${i === 0 ? 'bg-gray-50' : ''}`}>
          <div className="relative">

export const PriorityAlert = ({ type, title, description, time, actionText }) => {
    ...
    return (
      <div className={`bg-white p-4 rounded-r-xl border border-gray-200 border-l-4 ${borderColor} flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-3 shadow-sm`}>

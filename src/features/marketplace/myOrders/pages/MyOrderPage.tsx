  ...
  return (
    <main className="min-h-screen bg-white py-8 px-4 md:px-16">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="bg-yellow-500 text-white px-4 py-2 rounded-lg flex items-center gap-2 text-xs font-bold cursor-pointer">
      ...
      <div className="bg-gray-50/50 p-3 rounded-lg flex gap-4 mb-8">
        {['Order Status', 'All Regions', 'Sort by'].map((filter) => (
          <div key={filter} className="flex-1 bg-white border border-gray-200 px-3 py-2 rounded-md flex justify-between items-center text-xs text-gray-500 cursor-pointer">
      ...
      <div className="mt-12">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="relative">
            ...
            <input type="text" placeholder="Search your orders" className="pl-9 pr-4 py-2 border border-gray-100 rounded-lg text-xs outline-none w-64" />
          </div>
        </div>
